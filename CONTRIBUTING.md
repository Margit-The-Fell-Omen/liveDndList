...
Thank you for considering contributing! To be able to contribute to this project contact me vai
email: *timtk.work@gmail.com*. This document explains the process for proposing, implementing, and
reviewing changes.

## Workflow Overview

1. **Open an issue**:
    - Go to the `Issues` tab and create a new issue describing the feature or fix (
      see [Creating Issues](#creating-issues));
...
3. **Implement the feature**:
    ...
    - Make your changes, committing them according to
...
5. **Review & merge**:
    - A pull request requires approval from [me](https://github.com/Margit-The-Fell-Omen);
    - Once approved, merge the PR and delete the branch (
      see [Reviewing Pull Requests](#reviewing-pull-requests)).
...
- Each PR requires my approval to be merged;
...
- **Only pull requests** are moved to `In Review`. The linked issue should remain in `In Progress`
  until the PR is fully approved and merged;
