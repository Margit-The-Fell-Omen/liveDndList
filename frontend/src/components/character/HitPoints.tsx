    ...
    <div className={styles.hitPoints}>
      ...
      <div className={styles.inputs}>
        <Input
          ...
          onChange={(e) =>
            updateNestedCharacter('hitPoints.current', parseInt(e.target.value, 10) || 0)
          }
          min={0}
        />
        ...
        <Input
          ...
          onChange={(e) =>
            updateNestedCharacter('hitPoints.maximum', parseInt(e.target.value, 10) || 1)
          }
          min={1}
        />
        ...
        <Input
          ...
          onChange={(e) =>
            updateNestedCharacter('hitPoints.temporary', parseInt(e.target.value, 10) || 0)
          }
          min={0}
        />
      </div>
      ...
      {hitPoints.temporary > 0 && (
        <div className={styles.tempHpIndicator}>+{hitPoints.temporary} Temporary HP</div>
      )}
    </div>
  );
}
